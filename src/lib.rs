...
#[derive(Debug)]
pub struct HighMountainProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HighMountainProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HighMountain processing");
    
    let mut processor = HighMountainProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HighMountainProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HighMountainProcessor::new(false);
